...
해당 문제를 풀면서, 제시된 예제와 내가 만든 예제들은 답이 제대로 나오는데, 정작 체점을 하면 오답으로 나와 끙끙 앓았다.. 논리적 결함을 도저히 못 찾겠어서 다른 분들의 답을 보니, 제 코드는 자료형의 범위에 대한 고려가 되어 있지 않다는 것이 였다... 그래서 자료형을 수정해주니 정답이었다... :(
